    ...
    <div class="team-form-page">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="form-group">
                ...
                <input id="name" v-model="team.name" type="text" placeholder="Nombre del equipo" required />
            ...
            <div class="form-group">
                ...
                <textarea id="description" v-model="team.description"
                    placeholder="Descripción del equipo (opcional)"></textarea>
            </div>

            <!-- Ubicación -->
            <div class="form-group">
                <label for="location">Ubicación</label>
                <input id="location" v-model="team.location" type="text" placeholder="Ubicación (opcional)" />
            </div>

            <!-- Categoría -->
            <div class="form-group">
                <label for="category">Categoría</label>
                <select id="category" v-model="team.category" class="styled-select" required>
            ...
            <div class="form-group">
                ...
                <input id="division" v-model="team.division" type="text" placeholder="División del equipo" required />
